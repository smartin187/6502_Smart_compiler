...
>`0x02E7`: save of A (for return-function)<br>`0x02E8`: value of return-function<br>`0x02E9`: 01 if need to call `else bloc` (after `if`). If 0x02E9 = 01 bloc `else` or `elif` are called.<br>`0x02EA`: used for math (for operator `*` and `/`).
